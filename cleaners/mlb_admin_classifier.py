...
_ADMIN_PATTERNS: list[tuple[re.Pattern[str], str]] = [
    ...
    (re.compile(r"^On-field Delay\b", re.I), "on_field_delay"),
    (re.compile(r"^Game Advisory$", re.I), "game_advisory"),
    (re.compile(r"^Status Change\b", re.I), "game_advisory"),
    (re.compile(r"^Umpire Substitution\b", re.I), "umpire_substitution"),
    (re.compile(r"^Umpire change\b", re.I), "umpire_substitution"),
    (re.compile(r"^Pitcher Switch\b", re.I), "pitcher_switch"),
    (
        re.compile(r"\bis now pitching\b", re.I),
        "pitcher_switch",
    ),
    (
        re.compile(r"^Pitcher .+ enters the batting order\b", re.I),
        "pitcher_batting_order",
    ),
