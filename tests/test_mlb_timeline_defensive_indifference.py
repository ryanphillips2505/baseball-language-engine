...
def test_mlb_timeline_marks_defensive_indifference_as_game_event():

    raw = """
Major League Baseball

Nolan Schanuel walks.
Defensive indifference. Nolan Schanuel to 2nd.
...
"""
    ...
    assert blocks[1].event_type == "defensive_indifference"
